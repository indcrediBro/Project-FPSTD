...
public class Coin : Interactable
{
    ...
    {
        m_isCollected = false;
        Vector3 randomDirection = new Vector3(RandomNumber.Instance.NextFloat(-1f, 1f), 1f,
            RandomNumber.Instance.NextFloat(-1f, 1f)).normalized;
    ...
    private IEnumerator CollectCoinCO()
    {
        ...
        yield return new WaitForSeconds(1f);
        EconomyManager.Instance.EarnMoney(WaveManager.Instance.GetCurrentWave());
